		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvmlinvoicegenerator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvmlinvoicegenerator-display": {
								"semanticObject": "comvmlinvoicegenerator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vml.invoicegenerator",
									"url": sap.ui.require.toUrl("com/vml/invoicegenerator")
								}
							}
						}
					}
